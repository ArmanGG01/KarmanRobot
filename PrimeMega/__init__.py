...
if ENV:
    ...
    DB_URL = os.environ.get("DATABASE_URL2").replace("postgresql://qudlcfqy:7zG90yWdnJqMSPZllSErKuG5LHmcvbbW@heffalump.db.elephantsql.com/qudlcfqy")
